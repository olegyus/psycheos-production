"""
PsycheOS Interpreter Bot - System Prompts
All prompts from production documentation
"""

# ===== BASE SYSTEM PROMPT =====
# Always prepended to state-specific prompts
...
def assemble_prompt(state: str, session_context: dict) -> str:
    """
    Assemble complete prompt for given state.
...
if __name__ == '__main__':
    ...
    prompt = assemble_prompt('INTAKE', test_context)
    print("✓ Prompts module loaded")
    print(f"  States available: {len([k for k in dir() if k.endswith('_PROMPT')])}")
